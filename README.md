...
* **FirstPerson**, _by AlexanderGheorghe_ : a collection of scripts for implementing first person controls. includes demo scene based on Loft3D and unitypackage
